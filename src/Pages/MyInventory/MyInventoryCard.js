...
const MyInventoryCard = ({ myItem, handleInventoryDelete }) => {
    ...
    <div className="card lg:card-side bg-base-100 shadow-xl m-12 lg:flex-row-reverse">
      <div className="card-actions content-top justify-end ">
        <button
          ...
          className="btn btn-circle btn-outline btn-error m-5"
        >
          <svg
      ...
      <div className="card-body">
        ...
        <p>
          <small className="text-muted">{details.slice(0, 100)}...</small>
        </p>
      </div>
    </div>
  );
